        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    ...
                    <x-inputs.hidden
                        name="carVersion.name"
                        wire:model="carVersion.name"
                    ></x-inputs.hidden>
        ...
        <table class="table table-borderless table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-left">
                        @lang('crud.car_model_car_versions.inputs.name')
                    </th>
                    <th class="text-left">
            ...
            <tbody class="text-gray-600">
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="text-left">{{ $carVersion->name ?? '-' }}</td>
                    <td class="text-left">
            ...
            <tfoot>
                <tr>
                    <td colspan="5">{{ $carVersions->render() }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
